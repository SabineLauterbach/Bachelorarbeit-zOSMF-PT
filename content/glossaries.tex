...
Im Beispiel \ref{fig:jclBsp} Zeilennummer zwölf bis fünfzehn und neunzehn.
Hier ist auch zu sehen, dass Daten Inline an ein DD-Statement übergeben werden können.
\cite[S. 274]{Ebbers.2011}
\begin{figure}[h]
\centering
...
{
	name=Docker,
	description={Docker ist eine offene Plattform für die Entwicklung, Paketierung und Ausführen von Anwendungen auf verteilten Systemen. Zu diesen Systemen zählen unter anderem die Cloud, Datenzentren oder virtuelle Maschinen.
	\cite[Kap. \glqq Setting the Environment\grqq]{Vohra.2016}}
}

\newglossaryentry{vsam}
{
	name=VSAM,
	description={Virtual Storage Access Method, spezielle z/OS Dateiart, die schnelle I/O-Zugriffe ermöglicht.
	\cite[S. 2-4]{Lovelace.2013}}
}
...
Datenbanken, Tabellen usw. und ihren Strukturen.
\cite[S. 61]{Adams.2016}}
}