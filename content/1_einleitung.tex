...
Bis in die 90er Jahre spielte der IBM Mainframe eine Hauptrolle auf dem Computermarkt, dann gewannen zunehmend verteilte Client-Server-Systeme an Bedeutung.\footnote{[Kap. 5]\cite{Ceruzzi.2003}}
...
All diese Punkte sprechen nach wie vor für die Nutzung eines Großrechners, z.B. auch bei der DATEV e.G., weshalb man nach Einführung der IBM z14 Plattform 2019 als Referenzkunde agierte. https://www.ibm.com/downloads/cas/AGW2EEP0 
...
Wie in der Abbildung \ref{fig:Programmiersprachen} zu sehen ist, ist COBOL mit circa 46\% Prozent die am häufigsten verwendete Programmiersprache am Großrechner bei der DATEV e.G.. (Kommentar: in der Abbildung 1.1 ist DATEV eG statt e.G.)
...
IBM bietet eine Lösung mit dem Tool \glqq IBM Cloud Provisioning and Management for z/OS\grqq. 
