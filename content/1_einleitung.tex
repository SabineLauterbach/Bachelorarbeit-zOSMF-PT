...
Inklusiver dieser Transaktionen verarbeiten Großrechner heutzutage weltweit cira 1,2 Millionen CICS Transaktionen pro Sekunde.\footnote{\cite{.23.11.2019b}}
...
Die Seite des Hochschulkompasses\footnote{\cite{.09.02.2020}} (Kommentar: heißt das kompass??) liefert z.B. weder für \glqq Mainframe\grqq{} noch für \glqq Großrechner\grqq{} einen Treffer.
...
2018 wurde mit den DATEV Produkten erstmals die Umsatz-MIlliarde erreicht. (Kommentar: Quelle einfügen)
...
Für die Entwicklung von neuen Online-Anwendungen im cloud-native Stil wurde bei der DATEV e.G. eine Platform-as-a-Service (PaaS)-Lösung geschaffen und neue DevOps Prozesse aufgebaut. (Kommentar: hier sollte schon ein Verweis auf die Definition von DevOps kommen, oder?)
Dies ist im Cloud-Zeitalter nötig, um mit einer verbesserten Entwicklungseffizienz und neuen Architekturen Anwendungen ("Apps") schneller auf den Markt bringen und auf Kundenanforderungen schneller reagieren zu können. Stichwort: Continuous Integration, COntinuous Delivery (CI/CD).
EIn Baustein der effizientern Prozesse durch PaaS sind die sog. "Self Services".
...
Den Entwicklern steht, neben modernen Entwicklungsumgebungen (IDE) (Kommentar: Integrated Development Environment wie IntelliJ oder Eclipse) und einer Sourceverwaltung mit GIT, auch eine sog. \glqq Toolchain\grqq{} zur Verfügung. Diese beinhaltet Tools für Build, Test, Quality Gates und Deployment. 
Damit wird der Entwicklungsprozess automatisiert und man erhofft sich eine hohe Entwicklereffizient. (Kommentar: hier würde ich nach wie vor die Grafik von unserem go/cloud Sharepoint mit einbinden)
...
Gerade bei Mitarbeitern im Betrieb, die als Administratoren für die Middleware-Produkte arbeiten, sind die Bedenken groß, ob man diese Cloud-Vorgehensweise auf hochspezialisierte individuelle Komponenten wie CICS, DB2, IBM MQ anwenden kann.
IBM bietet eine Lösung mit dem \glqq IBM Cloud Provisioning and Management for z/OS\grqq-Toolkit. Dies hat sich noch nicht flächendeckend durchgesetzt, aber es herrscht großes Interesse an Erfahrungen und Einschätzungen bei IBM Kunden.
