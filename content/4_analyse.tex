...
Die Architektur wird in \ref{cicsarch} beschrieben.
...
\subsection{CICS in diesem Umfeld}

\subsubsection{Architektur}\label{cicsarch}

\subsubsection{Aktueller Bereitstellungsprozess}
