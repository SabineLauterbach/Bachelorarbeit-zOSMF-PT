...
\subsection{IBM Mainframe Architektur bei der DATEV eG}
Informationen für diesen Absatz stammen aus Gesprächen mit Mitarbeitern der einzelnen Administratorenteams.
...
\section{Stages, Sysplexe und Logical Partitions}\label{sec:sysplex}
