...
Die Docker Container werden über Images beschrieben und beinhalten neben der Anwendung alles das, was die Anwendung an Middleware-Komponenten und Services zur Laufzeit benötigt, Bibliotheken, Dateien.\footnote{\cite[Kap. 1]{Vohra.2016}}
...
Als Type können beispielhaft CICS oder auch WINDOWSNT für Windows unterstütze Plattformen genannt werden.
Ist der Type CICS,  muss der Name der Transaktion angegeben werden, für Windows Plattformen der Dateipfad der auszuführenden exe. (Kommentar: bei den anderen Begriffen wurde nur beim ersten mal mit Quotes gearbeitet, danach ohne. Für die Konstistenz solltest du das auch bei Type so machen, oder was meinst du?)
...
In den anschließenden Gesprächen wurde deutlich, dass sich neben der DATEV e.G. und der IBM auch andere Kundenfirmen für die automatisierte Provisionierung von z/OS Middleware mit \glqq IBM Cloud Provisioning and Management for z/OS\grqq{} interessieren, aber noch kaum Erfahrung in dem Umfeld besteht. (Kommentar: vlt. magst du noch so was hinzufügen wie: was auch durch Nachfrage bei IBM-SPezialisten (siehe Mail v. T. Leicher im Anhang) nochmals bestätigt wurde.)
...
Innerhalb eines Steps können sowohl interne und externe Scripte als auch JCLs (Kommetnar, muss man da ins Glossar verlinken? keine Ahnung?) und somit z/OS Programme ausgeführt werden.
...
Somit können das Template und die in dem Aktiondefintionfile definierten Aktionen vor der Veröffentlichung getestet werden.
