...
\subsection{REXX}
Die Restructured Extended Executor Programmiersprache, kurz REXX, ist eine prozedurale Programmiersprache.
...
\section{IBM Mainframe Architektur bei der DATEV e.G.}
Folgende Begriffe werden in diesem Absatz im Umfeld der DATEV e.G. erläutert:
...
Hier werden vor allem Integrationstests mit extra dafür erstellten Testdaten durchgeführt.
